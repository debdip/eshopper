                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="homepage.php"><img src="images/home/logo1.png" alt="" /></a>
                            </div>
                        </div>
                        <div class="col-sm-8">
					...
					<div class="login-form"><!--login form-->
                                       ...
                                       ?>
                                           ...
                                           if(isset($_POST["submit_for_img"])){ ?>
                                             ...
                                             <form method="post"action="account_manage.php">
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
                                            <?php if( isset($_POST["submit"])){
                                                    setcookie('n', $_POST["customer_name"], time()+(60*20));
                                 		...
                                 		<h2>New User Signup!</h2>
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    <input type="text" name="customer_name" placeholder="Name" required <?php if(isset($_POST["submit"])){ ?> value= <?php echo $_POST["customer_name"];} else if(isset($_COOKIE['n'])) {echo $_COOKIE['n'];} ?>  />
                                                    <input name="email" type="text" placeholder="something@something.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required <?php if(isset($_POST["submit"])){ ?> value= <?php echo $_POST["email"]; } ?>  > 
                                                    <input type="password"  name="password" placeholder="Password"  title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" <?php if(isset($_POST["submit"])){ ?> value= <?php echo $_POST["password"];} ?>/>
                                                   ...
                                                   <?php if(isset($_POST["repassword"])){
                                                    ...
                                                    Male<input  id= radio type="radio" name="gender" value="male" checked /> <br>
                                                    Female<input id=radio type="radio" name="gender" value="female"/><br>
                                                    Other<input id=radio type="radio" name="gender" value="other" ><br> 
                                                    date of birth(before 2005!)<input name="dob" type ="date" max="2005-01-01"/>
                                                    <br>
                                                   Country
