                                                           ...
                                                           ?>
                                                            <select name="action" onchange="location = this.value;" >
                                                                <option selected="true" disabled>admin mode</option>
                                                                    <option value="admin1.php?action=add_comp" >add computer</option>
                                                                    <option value="admin1.php?action=add_tv" >add new tv</option>
                                                                    <option value="admin1.php?action=update_comp" >Edit computer</option>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span><font  face="URW Chancery L">e</font></span>-SHOPPER</h1>
									...
									<h2><?php echo $xml_off->product[$i]->product_name; ?></h2>
                                                                        <h2>New Product</h2>
                                                                            ...
                                                                            ?>
                                                                        <a href="homepage.php?id=<?php echo $i+1;?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> 
                                                                        <br> <?php //echo $xml->product[$i]->product_name;
                                                                                    $id = $xml_off->product[$i]->product_id;
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span><font  face="URW Chancery L" size=30>e</font></span>-SHOPPER</h1>
                                                                        <?php $xml_off = $db->get_all_productname();
                                                                        $i = count($xml_off)-3;
                                                                        ?>
									<h2><?php echo $xml_off->product[$i]->product_name; ?></h2>
								...
								<div class="single-products">
										<div class="productinfo text-center">
										   ...
										   echo '<font color=red>'.$xml->product[$i]->price.'</font>' .'/=';             
                                                                                   echo nl2br("\n");
                                                                                   echo '<font size=3px>'.$xml->product[$i]->product_name.'</font>';
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
                                                                                   ...
                                                                                   $img =$xml->product[$i]->path;                                                                                                                                                                                               
                                                                                   echo '<img src ="'.$img.'">';                                                                                   
										   echo '<font color=red>'.$xml->product[$i]->price.'</font>' .'/='.'<br>';
									          ...
									          echo '<font size=3px>'.$xml->product[$i]->product_name.'</font>';
                                                                                   ...
                                                                                   <?php }
                                                                                      ...
                                                                                      $xml_1 = $db->get_tv_configuration($name_1);
                                                                                      ?>
                                                                                    <details style="color:black;font-size: 20px;">
                                                                                        <?php
                                                                                        echo 'brand : '.$xml_1->product->brand.'<br>';
                                                                                        echo 'display_size : '.$xml_1->product->display_size.'<br>';
                                                                                        echo 'monitor : '.$xml_1->product->monitor;
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
                                                                                   ...
                                                                                   echo '<img src ="'.$img.'">';                                                                                   
										   echo '<font color=red>'.$xml->product[$i]->price .'</font>'.'/='.'<br>';
                                                                                    echo '<font size=3px>'.$xml->product[$i]->product_name.'</font>'.'<br>';
									           //echo nl2br('<details> <summary>details</summary><p>"'.$xml->product[$i]->configuration.'"</p> </details>');
                                                                                   $name_1 = $xml->product[$i]->product_name;
                                                                                   if($xml->product[$i]->category_name != 'tv'){
                                                                                        $xml_1 = $db->get_computer_configuration($name_1);
